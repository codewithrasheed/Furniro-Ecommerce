...
//       <div className="mb-8">
//         <div className="flex md:flex-row md:justify-center flex-col gap-8">
//           <div>
...
//             <div className="aspect-square relative bg-[#F9F1E7] rounded-lg w-[280px] h-[170px]">
//               <Image
...
//             <button className="bg-[#B88E2F] w-[240px] h-[30px] px-8 py-2 rounded-lg text-white flex items-center justify-between">
//               Choose a Product{" "}
...
//               <button className="w-[215px] h-[60px] bg-[#B88E2F] hover:bg-[#B88E2F]/90 text-white">
//                 Add To Cart
//               </button>
//             </div>
